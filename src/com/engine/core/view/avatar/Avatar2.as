package com.engine.core.view.avatar
{
	...
	public class Avatar2 extends DisplaySprite implements IAvatar
	{
		...
		{
			if (_arg_1.avatarType == AvatarUnitTypes.BODY_TYPE) {
		...
		{
			var _local_2:Object;
			if (_arg_1.type == AvatarUnitTypes.BODY_TYPE) {
				...
				if (_arg_1.type == AvatarUnitTypes.EFFECT_TYPE) {
		...
		public function loadAvatarPart(avatarType:String, avatarNum:String):String
		{
			...
			if (avatarType == AvatarUnitTypes.MOUNT_TYPE) {
				if (avatarNum) {
					this.isOnMonut = true;
			...
			if (avatarNum) {
				...
				switch (avatarType) {
					case AvatarUnitTypes.BODY_TYPE:
						if (this.bmp_mid) {
							this.bmp_mid.bitmapData = null;
						}
						break;
					case AvatarUnitTypes.WEAPON_TYPE:
						if (this.bmp_wid) {
							this.bmp_wid.bitmapData = null;
						}
						break;
					case AvatarUnitTypes.WING_TYPE:
						if (this.bmp_wgid) {
							this.bmp_wgid.bitmapData = null;
						}
						break;
					case AvatarUnitTypes.MOUNT_TYPE:
						if (this.bmp_midm) {
							this.bmp_midm.bitmapData = null;
						}
						break;
					case AvatarUnitTypes.FLY_TYPE:
						if (this.bmp_fid) {
							this.bmp_fid.bitmapData = null;
						}
						break;
		...
		public function onRender(parts_id:String, _arg_2:int, _arg_3:BitmapData, _arg_4:Rectangle, _arg_5:String, _arg_6:String=null, _arg_7:int=0, _arg_8:int=0, _arg_9:BitmapData=null):void
		{
			...
			if (((!(this.isDisposed)) && (this.stage))) {
				...
				if (_arg_5 == AvatarUnitTypes.BODY_TYPE) {
					...
					if (_arg_5 == AvatarUnitTypes.FLY_TYPE) {
						...
						if (_arg_5 == AvatarUnitTypes.WEAPON_TYPE) {
							...
							if (_arg_5 == AvatarUnitTypes.WING_TYPE) {
								...
								if (_arg_5 == AvatarUnitTypes.MOUNT_TYPE) {
									...
									if (_arg_5 == AvatarUnitTypes.EFFECT_TYPE) {
		...
		public function removeAvatarPartByType(_arg_1:String):void
		{
			...
			switch (_arg_1) {
				case AvatarUnitTypes.EFFECT_TYPE:
					return;
				case AvatarUnitTypes.BODY_TYPE:
					return;
				case AvatarUnitTypes.WEAPON_TYPE:
